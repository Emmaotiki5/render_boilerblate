...
class ExpertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expert" do
    assert_difference("Expert.count") do
      post experts_url, params: { expert: { department: @expert.department, name: @expert.name, profile_picture: @expert.profile_picture } }
    end
  ...
  test "should update expert" do
    patch expert_url(@expert), params: { expert: { department: @expert.department, name: @expert.name, profile_picture: @expert.profile_picture } }
